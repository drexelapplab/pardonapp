...
var pdf_view_component_1 = __webpack_require__(/*! ./pdf-view/pdf-view.component */ "./src/app/pdf-view/pdf-view.component.ts");
var questions_set1_submit_component_1 = __webpack_require__(/*! ./questions-set1-submit/questions-set1-submit.component */ "./src/app/questions-set1-submit/questions-set1-submit.component.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                ...
                pdf_view_component_1.PdfViewComponent,
                questions_set1_submit_component_1.QuestionsSet1SubmitComponent,
            ],
            providers: [
                _guards_1.AuthGuard,
...
var appRoutes = [
    ...
    { path: 'pdf-view', component: pdf_view_component_1.PdfViewComponent },
    { path: 'question-set1-submit', component: questions_set1_submit_component_1.QuestionsSet1SubmitComponent },
    { path: '**', redirectTo: '' }
];
...
module.exports = "<div class=\"container\">\r\n  <svg id=\"PDF\"xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 612 792\"><title>PDF</title>\r\n    <image width=\"1275\" height=\"1650\" transform=\"scale(0.48)\" xlink:href=\"../../assets/images/svgtest.jpg\"/>\r\n    <text font-family=\"TimesNewRoman\" font-size=\"20\" fill=\"black\" transform=\"translate(100, 145)\">{{formData.firstname}} {{formData.middlename}} {{formData.lastname}}</text>\r\n    <text font-family=\"TimesNewRoman\" font-size=\"20\" fill=\"black\" transform=\"translate(100, 175)\">{{formData.street}}</text>\r\n    <text font-family=\"TimesNewRoman\" font-size=\"20\" fill=\"black\" transform=\"translate(100, 205)\">{{formData.city}}, {{formData.state}}, {{formData.zipcode}}</text>\r\n  </svg>\r\n</div>\r\n"
...
/***/ "./src/app/questions-set1-submit/questions-set1-submit.component.css":
/*!***************************************************************************!*\
  !*** ./src/app/questions-set1-submit/questions-set1-submit.component.css ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/questions-set1-submit/questions-set1-submit.component.html":
/*!****************************************************************************!*\
  !*** ./src/app/questions-set1-submit/questions-set1-submit.component.html ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container\">\r\n  <h1>Section 1 Submission</h1>\r\n  <div>\r\n    <p>You've successfully submitted your responses to Form Page 1!</p>\r\n    <p>Click 'Dashboard' to go back to the dashboard.</p>\r\n    <p>Click 'View PDF' to see your work on the official Pardon Application PDF.</p>\r\n    <p>Click 'Next' to move onto the next section of the form.</p>\r\n    <div class=\"button-row\">\r\n      <a routerLink=\"/dashboard\" class=\"button-routing left\"> Dashboard </a>\r\n      <a routerLink=\"/pdf-view\" class=\"button-routing center\"> View PDF </a>\r\n      <a routerLink=\"/questions-set2\" class=\"button-routing right\"> Next </a>\r\n      <router-outlet></router-outlet>\r\n    </div>\r\n  </div>\r\n  <div style=\"clear:both\"></div>\r\n</div>\r\n"

/***/ }),

/***/ "./src/app/questions-set1-submit/questions-set1-submit.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/questions-set1-submit/questions-set1-submit.component.ts ***!
  \**************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var QuestionsSet1SubmitComponent = /** @class */ (function () {
    function QuestionsSet1SubmitComponent() {
    }
    QuestionsSet1SubmitComponent.prototype.ngOnInit = function () {
    };
    QuestionsSet1SubmitComponent = __decorate([
        core_1.Component({
            selector: 'questions-set1-submit',
            template: __webpack_require__(/*! ./questions-set1-submit.component.html */ "./src/app/questions-set1-submit/questions-set1-submit.component.html"),
            styles: [__webpack_require__(/*! ./questions-set1-submit.component.css */ "./src/app/questions-set1-submit/questions-set1-submit.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], QuestionsSet1SubmitComponent);
    return QuestionsSet1SubmitComponent;
}());
exports.QuestionsSet1SubmitComponent = QuestionsSet1SubmitComponent;
...
var QuestSet1Component = /** @class */ (function () {
    ...
    QuestSet1Component.prototype.onFormSubmit = function (form) {
        ...
        this.api.postData(form)
            .subscribe(function (res) {
            var id = res['_id'];
            _this.router.navigateByUrl('/question-set1-submit');
        }, function (err) {
            console.log(err);
        });
